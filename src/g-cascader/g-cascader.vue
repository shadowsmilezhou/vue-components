  ...
  <div class="g-cascader" ref="cascader" v-click-outside="close">
    ...
    <div class="popover-wrapper" v-if="popoverVisible">
      <cascader-items :items="source" class="popover" :loadData="loadData"
                      ...
                      :height="popoverHeight" :selected="selected" @update:selected="onUpdateSelected">
      </cascader-items>
    </div>
...
<script>
  import CascaderItems from './g-cascader-items'
...
<style scoped lang="scss">
  ...
  .g-cascader {
    ...
    .popover-wrapper {
      ...
      margin-top: 8px;z-index: 1;overflow: auto;
      @extend .box-shadow;
    }
  }
